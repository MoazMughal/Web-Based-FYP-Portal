...
function CoordLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8000/coordinatorlogin", {
        email,
        password,
      });
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem("coordinatorEmail", response.data.email);
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 col-xl-6">
              <div className="text-center mb-3">
                ...
                <p className="text-muted mb-2">Coordinating Excellence in Project Management</p>
