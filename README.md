...
A comprehensive Final Year Project (FYP) management system for the Department of Computer Science, Quaid Azam University Islamabad.
...
```bash
git clone https://github.com/yourusername/Web-Based-FYP-Portal.git
...
```env
MONGODB_URI=mongodb://localhost:27017/Fyplogin
PORT=8000
